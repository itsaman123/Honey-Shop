  ...
  return (
    <>
      <section className="dark:bg-gray-900 text-white">
        <div className="centerh1 text-center mb-5 text-4xl " id="producttag">
          Products
        </div>
        ...
        <div className="grid gap-2 lg:grid-cols-4 ">
          {posts.map((items, key) => (
            <div
              className="w-full rounded-lg shadow-md lg:max-w-sm hover:border-indigo-400 hover:bg-gray-700 transition-colors duration-300"
              key={key}
            >
              <img
