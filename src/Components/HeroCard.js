  ...
  return (
    <>
      <section className="dark:bg-gray-900">
        <div
          className="centerh1 text-center mt-9 mb-5 text-4xl mx-5"
          id="colorh1"
        >
          About Us
        </div>
          ...
          <div className="container mx-auto px-4 py-8 md:flex md:items-center">
            ...
            <div className="md:w-1/2 text-white">
              ...
              <p className="text-white-900 text-xl text-white-900 transition-colors duration-300">
                ...
                ut ultricies eros, et placerat enim. Nullam tempus mauris vel
                sem malesuada, vitae convallis tellus tincidunt.
              </p>
